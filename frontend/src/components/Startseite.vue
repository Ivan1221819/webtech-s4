  ...
  <div class="recipe-search" :class="{ dark: darkMode, light: !darkMode }">
    ...
    <div class="search-wrap">
      <div class="search">
        ...
        />
        <button v-if="query" class="clear" @click="clearSearch" aria-label="Eingabe löschen">✕
        </button>
      </div>
      <small class="hint">Mindestens ein Begriff (auf Englisch !!)</small>
    </div>
    ...
    <div v-if="selectedMeal" class="modal" @click.self="selectedMeal = null">
      <div class="modal-content">
        <img v-if="selectedMeal.strMealThumb" :src="selectedMeal.strMealThumb"
             :alt="selectedMeal.strMeal" class="modal-poster" />
...
const ingredients = computed(() => selectedMeal.value ? buildIngredients(selectedMeal.value) : [])
...
.mode-toggle:hover, .wishlist-btn:hover {
  background: #222;
}
